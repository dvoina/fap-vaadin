package com.example.application.views.crops;
...
@Route(value = "crops", layout = MainView.class)
@PageTitle("Crops")
public class CropsView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public CropsView() {
        addClassName("crops-view");
        setSizeFull();
        grid.setHeight("100%");
