package com.example.application.views.farms;
...
@Route(value = "farms", layout = MainView.class)
@PageTitle("Farms")
public class FarmsView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public FarmsView() {
        addClassName("farms-view");
        setSizeFull();
        grid.setHeight("100%");
